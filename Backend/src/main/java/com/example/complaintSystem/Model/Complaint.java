...
public class Complaint {
    ...
    public Complaint(LocalDateTime date, ComplaintType complaintType, boolean status, int complaintCounter, int complaintResolutionCounter, long latitude, long longitude) {
        this.date = date;
