      ...
      <Container fluid>
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Collected pictures</p>
                      <Card.Title as="h4">{count.v}</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">On hold</p>
        ...
        <Row>
          <Col md="9">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Received camplaints</Card.Title>
              </Card.Header>
              <Card.Body>
